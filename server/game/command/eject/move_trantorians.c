...
static response_t *send_eject_response(trantorian_t *client,
    trantorian_t *trantorian2, zappy_t *zappy)
{
    ...
    send_gui_ppo(trantorian2, zappy);
    return response;
}
...
{
    clan_t *clan = NULL;
    clan_member_t *clan_member = NULL; response_t *response = NULL;
    int nb_trantorian_pushed = 0;
